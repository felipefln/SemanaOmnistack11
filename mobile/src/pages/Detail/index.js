...
export default function Detail() {
    ...
    const message = `Olá ${incident.name}, estou entrando em contato pois gostaria de ajudar com o valor de R$ ${incident.value}00 para ajudar a ${incident.description}.`;
